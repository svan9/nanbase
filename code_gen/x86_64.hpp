...
struct x86_64_CodeGen {
  ...
  void declare_label(const std::string& name) {
    // Регистрируем метку с placeholder позицией 0
    // Реальная позиция будет установлена когда встретим label()
    if (labels.find(name) == labels.end()) {
      labels[name] = SIZE_MAX;  // маркер "объявлена но не определена"
    }
  }
...
inline x86_64_CodeGen& pushi32(x86_64_CodeGen& cg, int32_t val) {
  cg.pushi32(val);
  return cg;
}
inline x86_64_CodeGen& pushi64(x86_64_CodeGen& cg, int64_t val) {
  cg.pushi64(val);
  return cg;
}
inline x86_64_CodeGen& push_r64(x86_64_CodeGen& cg, uint8_t reg) {
  cg.push_r64(reg);
  return cg;
}
inline x86_64_CodeGen& pop_r64(x86_64_CodeGen& cg, uint8_t reg) {
  cg.pop_r64(reg);
  return cg;
}
inline x86_64_CodeGen& mov_r64_imm64(x86_64_CodeGen& cg, uint8_t reg, uint64_t val) {
  cg.mov_r64_imm64(reg, val);
  return cg;
}
inline x86_64_CodeGen& mov_r32_imm32(x86_64_CodeGen& cg, uint8_t reg, uint32_t val) {
  cg.mov_r32_imm32(reg, val);
  return cg;
}
inline x86_64_CodeGen& mov_r64_r64(x86_64_CodeGen& cg, uint8_t dst, uint8_t src) {
  cg.mov_r64_r64(dst, src);
  return cg;
}
inline x86_64_CodeGen& add_r64_r64(x86_64_CodeGen& cg, uint8_t dst, uint8_t src) {
  cg.add_r64_r64(dst, src);
  return cg;
}
inline x86_64_CodeGen& sub_r64_r64(x86_64_CodeGen& cg, uint8_t dst, uint8_t src) {
  cg.sub_r64_r64(dst, src);
  return cg;
}
inline x86_64_CodeGen& imul_r64_r64(x86_64_CodeGen& cg, uint8_t dst, uint8_t src) {
  cg.imul_r64_r64(dst, src);
  return cg;
}
inline x86_64_CodeGen& idiv_r64(x86_64_CodeGen& cg, uint8_t src) {
  cg.idiv_r64(src);
  return cg;
}
inline x86_64_CodeGen& cmp_r64_r64(x86_64_CodeGen& cg, uint8_t left, uint8_t right) {
  cg.cmp_r64_r64(left, right);
  return cg;
}
inline x86_64_CodeGen& label(x86_64_CodeGen& cg, const std::string& name) {
  cg.label(name);
  return cg;
}
inline x86_64_CodeGen& jmp(x86_64_CodeGen& cg, const std::string& label) {
  cg.jmp(label);
  return cg;
}
inline x86_64_CodeGen& call(x86_64_CodeGen& cg, const std::string& label) {
  cg.call(label);
  return cg;
}
inline x86_64_CodeGen& ret(x86_64_CodeGen& cg) {
  cg.ret();
  return cg;
}
inline x86_64_CodeGen& prologue(x86_64_CodeGen& cg) {
  cg.prologue();
  return cg;
}
inline x86_64_CodeGen& epilogue(x86_64_CodeGen& cg) {
  cg.epilogue();
  return cg;
}
inline x86_64_CodeGen& exit(x86_64_CodeGen& cg, int32_t code) {
  cg.exit(code);
  return cg;
}
