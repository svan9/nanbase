...
#define GrabFromVM(var)                \
  memcpy(&var, vm.begin, sizeof(var)); \
  vm.begin += sizeof(var);
...
// defs
inline void VM_ManualPush(VirtualMachine& vm, u32 x);
inline void VM_Push(VirtualMachine& vm, byte head_byte, u32 number);
inline void VM_Push(VirtualMachine& vm);
inline void VM_Pop(VirtualMachine& vm);
inline void VM_RPop(VirtualMachine& vm);
...
inline void VM_Add(VirtualMachine& vm);
inline void VM_Sub(VirtualMachine& vm);
inline void VM_Mul(VirtualMachine& vm);
inline void VM_Div(VirtualMachine& vm);
inline void VM_Inc(VirtualMachine& vm);
inline void VM_Dec(VirtualMachine& vm);
inline void VM_Xor(VirtualMachine& vm);
inline void VM_Or(VirtualMachine& vm);
inline void VM_Not(VirtualMachine& vm);
inline void VM_And(VirtualMachine& vm);
inline void VM_LS(VirtualMachine& vm);
inline void VM_RS(VirtualMachine& vm);
void VM_ManualJmp(VirtualMachine& vm, u32 offset);
void VM_Jmp(VirtualMachine& vm);
void VM_Ret(VirtualMachine& vm);
inline void VM_Test(VirtualMachine& vm);
inline void VM_JE(VirtualMachine& vm);
inline void VM_JEL(VirtualMachine& vm);
inline void VM_JEM(VirtualMachine& vm);
inline void VM_JL(VirtualMachine& vm);
inline void VM_JM(VirtualMachine& vm);
inline void VM_JNE(VirtualMachine& vm);
inline void VM_Mov(VirtualMachine& vm);
inline void VM_Swap(VirtualMachine& vm);
void VM_MSet(VirtualMachine& vm);
inline void VM_Putc(VirtualMachine& vm);
inline void VM_Puti(VirtualMachine& vm);
inline void VM_Puts(VirtualMachine& vm);
void VM_Getch(VirtualMachine& vm);
inline void VM_LM(VirtualMachine& vm);
...
inline void VM_Lea(VirtualMachine& vm);
...
struct Emitter {
  ...
  void prologue() {
    ...
    buf.push_back(0x48);
    buf.push_back(0x89);
    buf.push_back(0xEC);  // mov rbp, rsp
    sub_rsp_shadow();
  }
...
static void jit_wrap_Lea(VirtualMachine* vm) { VM_Lea(*vm); }
  ...
  while (bc < bc_end) {
    ...
    switch (instr) {
      case Instruction_PUSH:
        wrapper = (void*)jit_wrap_push;
        break;
      case Instruction_POP:
        wrapper = (void*)jit_wrap_pop;
        break;
      case Instruction_RPOP:
        wrapper = (void*)jit_wrap_rpop;
        break;
      case Instruction_ADD:
        wrapper = (void*)jit_wrap_add;
        break;
      case Instruction_SUB:
        wrapper = (void*)jit_wrap_sub;
        break;
      case Instruction_MUL:
        wrapper = (void*)jit_wrap_mul;
        break;
      case Instruction_DIV:
        wrapper = (void*)jit_wrap_div;
        break;
      case Instruction_INC:
        wrapper = (void*)jit_wrap_inc;
        break;
      case Instruction_DEC:
        wrapper = (void*)jit_wrap_dec;
        break;
      case Instruction_XOR:
        wrapper = (void*)jit_wrap_xor;
        break;
      case Instruction_OR:
        wrapper = (void*)jit_wrap_or;
        break;
      case Instruction_NOT:
        wrapper = (void*)jit_wrap_not;
        break;
      case Instruction_AND:
        wrapper = (void*)jit_wrap_and;
        break;
      case Instruction_LS:
        wrapper = (void*)jit_wrap_ls;
        break;
      case Instruction_RS:
        wrapper = (void*)jit_wrap_rs;
        break;
      case Instruction_TEST:
        wrapper = (void*)jit_wrap_test;
        break;
      case Instruction_MOV:
        wrapper = (void*)jit_wrap_mov;
        break;
      case Instruction_SWAP:
        wrapper = (void*)jit_wrap_swap;
        break;
      case Instruction_MSET:
        wrapper = (void*)jit_wrap_mset;
        break;
      case Instruction_PUTC:
        wrapper = (void*)jit_wrap_putc;
        break;
      case Instruction_PUTI:
        wrapper = (void*)jit_wrap_puti;
        break;
      case Instruction_PUTS:
        wrapper = (void*)jit_wrap_puts;
        break;
      case Instruction_GETCH:
        wrapper = (void*)jit_wrap_getch;
        break;
      // case Instruction_CALL:  wrapper = (void*)jit_wrap_call;  break;

      // Переходы — вызываем обёртку и заканчиваем блок
      case Instruction_JMP:
        wrapper = (void*)jit_wrap_jmp;
        terminal = true;
        break;
      case Instruction_JE:
        wrapper = (void*)jit_wrap_je;
        terminal = true;
        break;
      case Instruction_JNE:
        wrapper = (void*)jit_wrap_jne;
        terminal = true;
        break;
      case Instruction_JL:
        wrapper = (void*)jit_wrap_jl;
        terminal = true;
        break;
      case Instruction_JM:
        wrapper = (void*)jit_wrap_jm;
        terminal = true;
        break;
      case Instruction_JEL:
        wrapper = (void*)jit_wrap_jel;
        terminal = true;
        break;
      case Instruction_JEM:
        wrapper = (void*)jit_wrap_jem;
        terminal = true;
        break;
      ...
      case Instruction_EXIT: {
        ...
        em.buf.push_back(0xC6);
        em.buf.push_back(0x00);
      ...
      default:
        ...
        em.mov_rax_imm64(begin_addr);
        em.mov_rcx_imm64((uint64_t)bc);
        em.buf.push_back(0x48);
        em.buf.push_back(0x89);
        em.buf.push_back(0x08);
        em.epilogue();
        goto done;
    }
      ...
      case Instruction_REG: {
        ...
        switch (ri->type) {
          case VM_RegType::R:
            ...
            break;
          case VM_RegType::RX:
            mew::gen_asgio(fn, a.getLong());
            break;
          case VM_RegType::FX:
            if (!depr_float) mew::gen_asgio(fn, a.getFloat());
            break;
          case VM_RegType::DX:
            if (!depr_float) mew::gen_asgio(fn, a.getDouble());
            break;
          default:
            MewCritical("undefined reg type (%i)", ri->type);
        }
        break;
      }
      default:
        MewCritical("undefined arg type (%i)", a.type);
    }
  }
    ...
    switch (a.type) {
          ...
          case Instruction_REG: {
            ...
            switch (ri->type) {
              case VM_RegType::R:
                ...
                break;
              case VM_RegType::RX:
                mew::gen_adgio(fn, a.getInt(), b.getLong());
                break;
              case VM_RegType::FX:
                if (!depr_float) mew::gen_adgio(fn, a.getInt(), b.getFloat());
                break;
              case VM_RegType::DX:
                if (!depr_float) mew::gen_adgio(fn, a.getInt(), b.getDouble());
                break;
              default:
                MewCritical("undefined reg type (%i)", ri->type);
            }
      ...
      case Instruction_REG: {
        ...
        switch (ri->type) {
              ...
              case Instruction_REG: {
                ...
                switch (ri->type) {
                  case VM_RegType::R:
                    ...
                    break;
                  case VM_RegType::RX:
                    mew::gen_adgio(fn, a.getLong(), b.getLong());
                    break;
                  case VM_RegType::FX:
                    if (!depr_float) mew::gen_adgio(fn, a.getLong(), b.getFloat());
                    break;
                  case VM_RegType::DX:
                    if (!depr_float) mew::gen_adgio(fn, a.getLong(), b.getDouble());
                    break;
                  default:
                    MewCritical("undefined reg type (%i)", ri->type);
                }
              ...
              case Instruction_REG: {
                ...
                switch (ri->type) {
                  case VM_RegType::R:
                    ...
                    break;
                  case VM_RegType::RX:
                    mew::gen_adgio(fn, a.getFloat(), b.getLong());
                    break;
                  case VM_RegType::FX:
                    mew::gen_adgio(fn, a.getFloat(), b.getFloat());
                    break;
                  case VM_RegType::DX:
                    mew::gen_adgio(fn, a.getFloat(), b.getDouble());
                    break;
                  default:
                    MewCritical("undefined reg type (%i)", ri->type);
                }
              ...
              case Instruction_REG: {
                ...
                switch (ri->type) {
                  case VM_RegType::R:
                    ...
                    break;
                  case VM_RegType::RX:
                    mew::gen_adgio(fn, a.getDouble(), b.getLong());
                    break;
                  case VM_RegType::FX:
                    mew::gen_adgio(fn, a.getDouble(), b.getFloat());
                    break;
                  case VM_RegType::DX:
                    mew::gen_adgio(fn, a.getDouble(), b.getDouble());
                    break;
                  default:
                    MewCritical("undefined reg type (%i)", ri->type);
                }
          ...
          default:
            MewCritical("undefined reg type (%i)", a.type);
        }
      } break;
      default:
        MewCritical("undefined arg type (%i)", a.type);
...
VM_ARG VM_GetArg(VirtualMachine& vm) {
  ...
  switch (type) {
    ...
    case Instruction_REG: {
      ...
      VM_REG_INFO* ri = vm.alloc_reg_info();
      ri->idx = ridx;
    ...
    default:
      MewCritical("undefined arg type (%i)", type);
  }
}
...
inline byte* VM_GetReg(VirtualMachine& vm, u64* size = nullptr) {
...
inline void VM_Putc(VirtualMachine& vm) {
  vm.debug.last_fn = (char*)__func__;
  wchar_t long_char;
  memcpy(&long_char, vm.begin, sizeof(wchar_t));
  vm.begin += sizeof(wchar_t);
...
void RunLine(VirtualMachine& vm) {
  static void* _dispatch_table[] = {
    &&op_none, &&op_ldll, &&op_call, &&op_push, &&op_pop, &&op_rpop,
    &&op_add, &&op_sub, &&op_mul, &&op_div,
    &&op_inc, &&op_dec, &&op_xor, &&op_or, &&op_not, &&op_and, &&op_ls, &&op_rs,
    &&op_num, &&op_struct, &&op_int, &&op_flt, &&op_dbl, &&op_uint, &&op_byte, &&op_mem, &&op_reg, &&op_heap, &&op_st,
    &&op_jmp, &&op_ret, &&op_exit, &&op_test, &&op_je, &&op_jel, &&op_jem, &&op_jne, &&op_jl, &&op_jm,
    &&op_mov, &&op_swap, &&op_mset, &&op_swst, &&op_write, &&op_read, &&op_wine, &&op_open, &&op_close,
    &&op_lm, &&op_lea, &&op_putc, &&op_puti, &&op_puts, &&op_getch, &&op_getvm, &&op_getiptr, 
    &&op_movrdi, &&op_dcall, &&op_gbch, &&op_srdi, &&op_ardi, &&op_wtm
  };
  ...
  // Без проверок - компилятор должен оптимизировать bounds
  goto *_dispatch_table[head_byte];
...
class CodeBuilder {
 ...
 public:
  CodeBuilder()
      : capacity(alloc_size), _code_size(0), _data_size(0), code(mew::mem::alloc(alloc_size)) { memset(code, 0, alloc_size); }
...
void je4vm(Waze& w) {
  const char* l = (const char*)w.pop();
  w.emitJump(Instruction_JE, l);
}
void jne4vm(Waze& w) {
  const char* l = (const char*)w.pop();
  w.emitJump(Instruction_JNE, l);
}
void jl4vm(Waze& w) {
  const char* l = (const char*)w.pop();
  w.emitJump(Instruction_JL, l);
}
void jm4vm(Waze& w) {
  const char* l = (const char*)w.pop();
  w.emitJump(Instruction_JM, l);
}
void jel4vm(Waze& w) {
  const char* l = (const char*)w.pop();
  w.emitJump(Instruction_JEL, l);
}
void jem4vm(Waze& w) {
  const char* l = (const char*)w.pop();
  w.emitJump(Instruction_JEM, l);
}
